...
const textInputNodeDefinition: CanvasNodeDefinition<TextInputNodeData> = {
  type: CANVAS_NODE_TYPES.textInput,
  menuLabelKey: 'node.menu.textInput',
  menuIcon: 'text',
  visibleInMenu: true,
  capabilities: {
    toolbar: true,
  ...
  createDefaultData: () => ({
    displayName: DEFAULT_NODE_DISPLAY_NAME[CANVAS_NODE_TYPES.textInput],
    content: '',
  }),
};
...
export const canvasNodeDefinitions: Record<CanvasNodeType, CanvasNodeDefinition> = {
  ...
  [CANVAS_NODE_TYPES.textInput]: textInputNodeDefinition,
