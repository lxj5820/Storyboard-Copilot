...
} from '@/features/canvas/app/imageNodeSizing';
import {
      ...
      >
        {data.imageUrl ? (
          <CanvasNodeImage
            ...
            resolution={'size' in data ? (data.size as string) : undefined}
            aspectRatio={'requestAspectRatio' in data ? (data.requestAspectRatio as string) : data.aspectRatio}
          />
        ) : hasGenerationError ? (
