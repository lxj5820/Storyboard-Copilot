...
import { canvasAiGateway, canvasEventBus } from '@/features/canvas/app/canvasServices';
import {
  CANVAS_NODE_TYPES,
  type CanvasEdge,
  type CanvasNode,
...
import { prepareNodeImage } from '@/features/canvas/app/imageData';
import {
  buildGenerationErrorReport,
  CURRENT_RUNTIME_SESSION_ID,
} from '@/features/canvas/app/generationErrorReport';
import { showErrorDialog } from '@/features/canvas/app/errorDialog';
import {
...
function canNodeTypeBeManualConnectionSource(type: CanvasNodeType): boolean {
  return (
    ...
    type === CANVAS_NODE_TYPES.textInput ||
